...
from refactron.analysis.taint import TaintAnalyzer, TaintConfig, TaintSource, TaintSink
...
"""
    ...
    assert isinstance(entry.statements[0], ast.If) == False # The If node visitor handles this, stmt list gets 'x' (test)
