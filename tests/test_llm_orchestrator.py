...
from refactron.llm.models import SuggestionStatus, RefactoringSuggestion
...
"""
    ...
    def test_bad_llm_response(self, mock_client, sample_issue):
        ...
        assert "JSONDecodeError" in suggestion.explanation or "Expecting value" in suggestion.explanation
