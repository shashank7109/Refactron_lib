...
class TestContextRetriever:
    ...
    def test_retriever_initialization(self, mock_transformer, mock_settings, mock_chroma, temp_workspace):
    ...
    @patch('refactron.rag.retriever.Settings')
    @patch('refactron.rag.retriever.SentenceTransformer')
    def test_retriever_missing_index(self, mock_transformer, mock_settings, mock_chroma, temp_workspace):
    ...
    @patch('refactron.rag.retriever.Settings')
    @patch('refactron.rag.retriever.SentenceTransformer')
    def test_retrieve_no_results(self, mock_transformer, mock_settings, mock_chroma, temp_workspace):
