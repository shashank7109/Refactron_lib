...
''')
    ...
    def test_indexer_initialization(self, mock_parser, mock_transformer, mock_settings, mock_chroma, temp_workspace):
    ...
    @patch('refactron.rag.indexer.SentenceTransformer')
    @patch('refactron.rag.indexer.CodeParser')
    def test_add_chunks(self, mock_parser, mock_transformer, mock_settings, mock_chroma, temp_workspace):
    ...
    @patch('refactron.rag.indexer.SentenceTransformer')
    @patch('refactron.rag.indexer.CodeParser')
    def test_add_empty_chunks(self, mock_parser, mock_transformer, mock_settings, mock_chroma, temp_workspace):
    ...
    @patch('refactron.rag.indexer.SentenceTransformer')
    @patch('refactron.rag.indexer.CodeParser')
    def test_get_stats(self, mock_parser, mock_transformer, mock_settings, mock_chroma, temp_workspace):
        ...
        indexer._save_metadata({
            "total_chunks": 10,
            "total_files": 2,
            "chunk_types": {"function": 8, "class": 2}
        })
